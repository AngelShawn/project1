...
class LstmLayer(object):
    ...
    def init_weight_mat(self):
        ...
        :return:
        '''
        Wh = np.random.uniform(-1e-4, 1e-4,(self.state_width, self.state_width)) # 短期记忆
        Wx = np.random.uniform(-1e-4, 1e-4,(self.state_width, self.input_width)) # 输入
    ...
    def cal_delta(self,delta_h,activator):
        # 初始化每个时刻的误差项
